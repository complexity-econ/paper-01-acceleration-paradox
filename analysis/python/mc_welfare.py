...
axes[0, 0].set_xlabel("Real consumption per capita (PLN/month)")
axes[0, 0].set_ylabel("Seed count")
axes[0, 0].set_title("A. Real consumption per capita", fontweight='bold')
axes[0, 0].legend()
...
axes[0, 1].set_ylabel("Seed count")
axes[0, 1].set_title("B. Income inequality (Gini)", fontweight='bold')
axes[0, 1].legend()
...
axes[1, 0].set_ylabel("Real consumption per capita (PLN)")
axes[1, 0].set_title("C. Tradeoff: equality vs consumption", fontweight='bold')
axes[1, 0].legend()
...
axes[1, 1].set_title("D. Multidimensional comparison", fontweight='bold')
axes[1, 1].legend(loc='upper right', fontsize=7)

fig.suptitle("Welfare analysis — Monte Carlo (N=100 seeds per scenario)",
